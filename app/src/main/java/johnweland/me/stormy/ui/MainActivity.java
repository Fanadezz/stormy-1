...
import johnweland.me.stormy.weather.Current;
import johnweland.me.stormy.weather.Day;
import johnweland.me.stormy.weather.Forecast;
import johnweland.me.stormy.weather.Hour;
...
public class MainActivity extends ActionBarActivity {
    ...
    @InjectView(R.id.summaryValue) TextView mSummaryLabel;
    @InjectView(R.id.iconImageView) ImageView mIconImageView;
    @InjectView(R.id.refreshImageView) ImageView mRefreshImageView;
    @InjectView(R.id.progressBar) ProgressBar mProgessBar;
    ...
    private void getForecast(double latitude, double longitude) {
        String apiKey = "9b176c486dcad0eaf7d6116ac46a0957";
    ...
    private void toggleRefresh() {
        if (mProgessBar.getVisibility() == View.INVISIBLE) {
    ...
    private Day[] getDailyForecast(String jsonData) throws JSONException {
        ...
        for (int i = 0; i < data.length(); i++) {
            ...
            //day.setTemperatureMin(jsonHour.getDouble("temperatureMin"));
